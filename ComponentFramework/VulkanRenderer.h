...
public:
	...
	void SetPushConstant(const PipelineInfo pipelineInfo, const ModelMatrixPushConst& pushConts_);
...
public:
	void CreateColourPickerPipeline(const char* vertFile, const char* fragFile ,std::vector<BufferMemory> cameraUBO);
...
private:
    ...
    void CreateColourPickerFramebuffer(VkFramebuffer& framebuffer, VkImageView, VkImageView, VkRenderPass);
	void DestroyFramebuffer(VkFramebuffer& framebuffer);

	void CreateColourPickerReadbackBuffer(BufferMemory& bufferMemory);
	void DestroyColourPickerReadbackBuffer(BufferMemory& bufferMemory);

	void CreateColourPickerCommandBuffer(CommandBufferData& commandBufferData);    
	void CreateColourPickerCommandPool(VkCommandPool& commandPool);
	void AllocateColourPickerCommandBuffers(CommandBufferData& commandBufferData, int count);
	void DestroyColourPickerCommandBuffer(CommandBufferData& commandBufferData);

	void CreateColourPickerFence(VkFence& fence);
	void DestroyColourPickerFence(VkFence& fence);
