...
void VulkanRenderer::CreateInstance() {
    ...
    VkApplicationInfo appInfo{}; // clears the "form" always do this when making a new form
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "Vulkan Renderer";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Game 308";                        // filling out the form
    appInfo.engineVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.apiVersion = VK_API_VERSION_1_0;

    VkInstanceCreateInfo createInfo{};
    createInfo.sType = VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO;
    createInfo.pApplicationInfo = &appInfo; // attaching the application info form to the instance create info form
...
void VulkanRenderer::SetPushConstant(const PipelineInfo pipelineInfo, const ModelMatrixPushConst &pushConts_) {
 
    for (uint32_t i = 0; i < getNumSwapchains(); i++) {
        vkCmdPushConstants(primaryCommandBuffer.commandBuffers[i], pipelineInfo.pipelineLayout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(ModelMatrixPushConst), &pushConts_);
    }
}
...
void VulkanRenderer::SetPushConstant(const PipelineInfo pipelineInfo, const Matrix4 &modelMatrix_) {
       ...
       modelMatrixPushConst.colour = 255; // not used currently
